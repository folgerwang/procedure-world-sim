...
Menu::Menu(
    ...
    weather_controls_.soil_temp_adj = 0.026f;
    // temperature changes by energy from sun minus energy vapored from water surface.
    weather_controls_.water_temp_adj = 0.0067f;
    ...
    weather_controls_.soil_moist_adj = 0.01062f;
    weather_controls_.water_moist_adj = 0.03173f;
    weather_controls_.transfer_ratio = 0.6f;
    weather_controls_.transfer_noise_weight = 0.4f;
