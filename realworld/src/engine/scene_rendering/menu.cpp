...
Menu::Menu(
    ...
    weather_controls_.soil_temp_adj = 0.00126f;
    // temperature changes by energy from sun minus energy vapored from water surface.
    weather_controls_.water_temp_adj = 0.00067f;
    ...
    weather_controls_.soil_moist_adj = 0.02124f;
    weather_controls_.water_moist_adj = 0.06173f;
